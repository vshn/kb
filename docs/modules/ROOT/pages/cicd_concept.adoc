...
The development environment is used for internal testing of changes to infrastructure such as
...
.Example Django
====
The https://gitlab.com/appuio/example-django[Example Django] project is a complete example that illustrates the recommended Continuous Integration / Continuous Deployment process.
====
